...
export const MOCK_PRODUCTS: Product[] = [
  ...
  { id: "p008", title: "Iogurte Natural", price: 3.49, unit: "170g", category: "laticinios", image: "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=400&q=80", description: "Iogurte natural integral, sem conservantes.", inStock: true },
  ...
  { id: "p013", title: "Carne Moída", price: 28.90, unit: "kg", category: "carnes", image: "https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=400&q=80", description: "Carne moída patinho, fresca e sem gordura excessiva.", inStock: true },
  ...
  { id: "p015", title: "Refrigerante Cola 2L", price: 7.99, unit: "2L", category: "bebidas", image: "https://images.unsplash.com/photo-1527960471264-932f39eb5846?w=400&q=80", description: "Refrigerante sabor cola, garrafa 2 litros.", inStock: true },
  { id: "p016", title: "Água Mineral 500ml", price: 1.99, unit: "500ml", category: "bebidas", image: "https://images.unsplash.com/photo-1559839914-17aae19cec71?w=400&q=80", description: "Água mineral natural sem gás, garrafa 500 ml.", inStock: true, badge: "oferta" },
  { id: "p017", title: "Detergente Neutro", price: 2.29, unit: "500ml", category: "limpeza", image: "https://images.unsplash.com/photo-1585515320310-259814833e62?w=400&q=80", description: "Detergente líquido neutro, 500 ml.", inStock: true },
  { id: "p018", title: "Sabão em Pó", price: 11.49, unit: "1kg", category: "limpeza", image: "https://images.unsplash.com/photo-1610557892470-55d9e80c0bce?w=400&q=80", description: "Sabão em pó multiação, 1 kg.", inStock: true },
  ...
  { id: "p020", title: "Feijão Carioca", price: 6.99, unit: "1kg", category: "mercearia", image: "https://images.unsplash.com/photo-1615485925600-97237c4fc1ec?w=400&q=80", description: "Feijão carioca premium, nova safra.", inStock: true },
  ...
  { id: "p022", title: "Macarrão Espaguete", price: 3.49, unit: "500g", category: "mercearia", image: "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=400&q=80", description: "Macarrão espaguete nº 8, 500 g.", inStock: true },
]
